  ...
  return (
    <main className="w-full h-full overflow-y-auto overflow-x-hidden relative">
      ...
      <div className="w-full flex justify-center flex-col space-y-8 items-center max-w-2xl text-center mx-auto mt-8 px-8">
        ...
        <h1 className="text-base font-medium p-2 rounded-md bg-gradient-to-tr from-blue-500 to-purple-500 text-white px-6">Free Open Source Tailwind CSS Components</h1>
        <h5 className="text-base leading-[30px] tracking-wider font-medium text-gray-700">
      ...
      <div className="max-w-2xl p-8 rounded-md shadow-2xl mx-auto mt-20 flex flex-col space-y-4 border border-gray-100 px-8">
      ...
      <div
        className="bg-indigo-600 max-w-6xl mx-auto px-4 py-3 text-white sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 mt-20 rounded-md"
      >
