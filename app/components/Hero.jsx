    ...
    return (
        <div className='mt-20 flex items-center justify-between'>
            <div className='flex-1'>
                <h1 className='text-2xl font-medium'>Top quality
                    open-source UI Components</h1>
                <h5 className='text-base font-light my-3'>Stunning components recreated with Tailwind CSS, but with better design and responsiveness</h5>
